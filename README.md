...
For legality reasons, none of this can say that the app I'm advertising can say that it's providing investment advice, and that the user should invest at their own risk. This is simply a tool to help find stocks of interest. Also remove any instance of saying that they will make a lot of money from it, as it is not a guarantee. Output it in md code: # Stock Contender 
